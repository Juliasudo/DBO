...
// We keep the function name as Features to avoid changing other files
const Features = () => {
  return (
    // We use the id="features" so the hero's scroll-down arrow works
    <section id="features" className="py-20 px-4 bg-light-bg dark:bg-dark-bg">
      <div className="container mx-auto">
        ...
        <div className="space-y-16">
          {/* This now correctly uses data.architecture */}
